        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer text-text-secondary hover:text-white transition-colors">
              <input type="checkbox" className="rounded bg-secondary-dark border-white/10 text-neon-purple focus:ring-neon-purple" />
              Remember me
            </label>
            <a href="#" className="text-neon-purple hover:underline">Forgot password?</a>
          </div>
